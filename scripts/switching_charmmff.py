...
from endstate_rew.system import create_charmm_system, initialize_simulation_charmm
...
sim = initialize_simulation_charmm(zinc_id=name)
###########################################################################################
# create folder
w_dir = f"/data/shared/projects/endstate_rew/{name}/switching_charmmff/run01/"
