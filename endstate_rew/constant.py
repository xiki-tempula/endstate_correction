...
zinc_systems = [
    ...
    ("ZINC00169358", "CC1=Cn2c(=O)c3ccccc3c(=O)n2C1"),
    ("ZINC01036618", "COc1ccc(/C=C2/N=C(c3ccccc3)NNC2=O)cc1"),
    ("ZINC01755198", "CC(C)C(=O)NNC(=O)C(C)C"),
    ("ZINC01867000", "c1ccc(-c2ccccc2-c2ccccc2)cc1"),
    ("ZINC03127671", "O=C(CSCC(=O)Nc1ccccc1)NNC(=O)c1ccccc1"),
    ("ZINC04344392", "CCOC(=O)NNC(=O)NCCCc1ccc2ccc3cccc4ccc1c2c34"),
    ("ZINC04363792", "Clc1cc(Cl)cc(/N=c2\ssnc2-c2ccccc2Cl)c1"),
    ("ZINC06568023", "O=C(NNC(=O)c1ccccc1)c1ccccc1"),
