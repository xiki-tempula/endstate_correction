...
def test_generate_molecule():
    ...
    coordinates = [[-7.45523175e-01,  4.14444551e-02,  1.17060656e-02],
                    [ 7.47339732e-01,  2.87860116e-03,  1.22331042e-03],
                    [-1.12970717e+00, -6.37431527e-01,  8.14421395e-01],
                    [-1.18489973e+00,  1.02557024e+00,  1.99636470e-01],
                    [-1.19987084e+00, -3.34603249e-01, -9.38879499e-01],
                    [ 1.08415333e+00, -7.36520284e-01, -7.73193261e-01],
...
def test_generate_simulation_instance():
    ...
    e_sim_qml_interpolate_endstate = get_energy(sim).value_in_unit(unit.kilojoule_per_mole)
